...
function getParams(cityName) {
    ...
    var method = "GETREALTIMEDATA";
    return getParam(method, obj);
}

//获取历史数据
function getHistory(cityName, st, et) {
    return getParam("CETCITYPERIOD", {
        city: cityName,
        type: 'HOUR',
        startTime: st,
        endTime: et
...
//获取历史数据
function getHistoryTest(a, b, c) {
    return getParamDebug("CETCITYPERIOD", {
        city: "杭州",
        type: "HOUR",
        startTime: "2022-11-24 10:00:43",
        endTime: "2022-11-25 13:17:43"
    })
}

//解密返回内容的方法入口
function getResultJson(str) {
    var shit = new Base64();
    datas = eval('(' + shit.decode(decryptData(str)) + ')');
...
//获取debug
function getParamDebug(method, obj) {
    var appId = '4f0e3a273d547ce6b7147bfa7ceb4b6e';
    var timestamp = new Date().getTime();
    var need = {
        appId: appId,
